...
public class G_m_8_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_m_8_2);
        ...
        btn1.setImageResource(R.drawable.one_euro_coin);
        btn2.setImageResource(R.drawable.euro_10);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_m_8_2.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_m_8_2.this, Table_Easy.class));
            }
        });
    ...
    public void checkIt(View view) {
        if (btn1.isSelected()&&btn2.isSelected()&&!btn3.isSelected()&&btn4.isSelected()){
            sound.playHitSound();
            startActivity(new Intent(this, G_m_8_3.class));
        }else {
            sound.playOverSound();
        }
    }

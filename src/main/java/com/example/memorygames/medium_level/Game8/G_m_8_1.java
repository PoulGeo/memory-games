package com.example.memorygames.medium_level.Game8;
...
public class G_m_8_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_m_8_1);
        ...
        btn1.setImageResource(R.drawable.euro_5);
        btn2.setImageResource(R.drawable.euro_50);
        btn3.setImageResource(R.drawable.euro_20);
        btn4.setImageResource(R.drawable.two_euro_coin);

        user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_m_8_1.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_m_8_1.this, Table_Easy.class));
            }
        });
    ...
    public void checkIt(View view) {
        if (btn1.isSelected()&&!btn2.isSelected()&&btn3.isSelected()&&!btn4.isSelected()){
            sound.playHitSound();
            startActivity(new Intent(this, G_m_8_2.class));
        }else {
            sound.playOverSound();
        }
    }

package com.example.memorygames.medium_level.Game1;
...
public class G_m_1_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_m_1_3);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_m_1_3.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_m_1_3.this, Table_Easy.class));
            }
        });
    ...
    public void right_ans(View view) {
        img6.setBackgroundColor(this.getColor(R.color.colorPrimary));
    ...
    public void playCherries(View view) {
        sound.playCherries();
    }
}
...
public class G_m_7_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_m_7_2);
        ...
        btn1.setImageResource(R.drawable.cube_13);
        btn2.setImageResource(R.drawable.hexagon4);
        btn3.setImageResource(R.drawable.cube2);
        btn4.setImageResource(R.drawable.cube5);
        btn5.setImageResource(R.drawable.triangle_5);
        btn6.setImageResource(R.drawable.cube1);

        user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_m_7_2.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_m_7_2.this, Table_Easy.class));
            }
        });
    ...
    public void checkIt(View view) {
        if (btn1.isSelected()&&!btn2.isSelected()&&btn3.isSelected()&&btn4.isSelected()&&!btn5.isSelected()&&btn6.isSelected()){
            ...
            sound.playHitSound();
            startActivity(new Intent(this, G_m_7_3.class));
        }else {

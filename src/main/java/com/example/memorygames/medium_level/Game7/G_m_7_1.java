...
import com.example.memorygames.easy_level.Game7.G_e_7_2;
import com.example.memorygames.easy_level.Table_Easy;

public class G_m_7_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_m_7_1);
        ...
        btn1.setImageResource(R.drawable.beach_ball);
        btn2.setImageResource(R.drawable.watermelon);
        btn3.setImageResource(R.drawable.triangle);
        btn4.setImageResource(R.drawable.cube4);
        btn5.setImageResource(R.drawable.circle2);
        btn6.setImageResource(R.drawable.abstract_2);

        user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_m_7_1.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_m_7_1.this, Table_Easy.class));
            }
        });
    ...
    public void checkIt(View view) {
        if (btn1.isSelected()&&btn2.isSelected()&&!btn3.isSelected()&&!btn4.isSelected()&&btn5.isSelected()&&btn6.isSelected()){
            ...
            sound.playHitSound();
            startActivity(new Intent(this, G_m_7_2.class));
        }else {

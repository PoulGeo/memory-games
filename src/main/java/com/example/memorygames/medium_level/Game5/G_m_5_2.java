...
public class G_m_5_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_m_5_2);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_m_5_2.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_m_5_2.this, Table_Easy.class));
            }
        });
    }
    ...
    public void right_ans(View view) {
        ...
        startActivity(new Intent(this, G_m_5_3.class));
        sound.playHitSound();
    }

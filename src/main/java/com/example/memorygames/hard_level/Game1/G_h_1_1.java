package com.example.memorygames.hard_level.Game1;
...
public class G_h_1_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_h_1_1);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_h_1_1.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_h_1_1.this, Table_Easy.class));
            }
        });
    ...
    public void right_ans(View view) {
        ...
        startActivity(new Intent(this, G_h_1_2.class));
        sound.playHitSound();
    }
    ...
    public void playGrapes(View view) {
        sound.playGrapes();
    }
}
...
public class G_h_1_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_h_1_2);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_h_1_2.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_h_1_2.this, Table_Easy.class));
            }
        });
    ...
    public void right_ans(View view) {
        img5.setBackgroundColor(this.getColor(R.color.colorPrimary));
        startActivity(new Intent(this, G_h_1_3.class));
		sound.playHitSound();
    }
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    public void playCarrot(View view) {
        sound.playCarrot();
    }
}
...
import com.example.memorygames.medium_level.Game5.G_m_5_3;
import com.example.memorygames.medium_level.Table_Medium;

public class G_h_5_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_h_5_1);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_h_5_1.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_h_5_1.this, Table_Easy.class));
            }
        });
    }
    ...
    public void right_ans(View view) {
        ch09.setBackgroundColor(this.getColor(R.color.colorPrimary));
        startActivity(new Intent(this, G_h_5_2.class));
        sound.playHitSound();
    }

...
import com.example.memorygames.hard_level.Game2.G_h_2_2;
import com.example.memorygames.medium_level.Game7.G_m_7_1;

public class G_h_7_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_h_7_1);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_h_7_1.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_h_7_1.this, Table_Easy.class));
            }
        });
    }
    ...
    public void right_ans(View view) {
        btn2.setBackgroundColor(this.getColor(R.color.colorPrimary));
        startActivity(new Intent(this, G_h_7_2.class));
        sound.playHitSound();
    }

...
public class G_h_6_2 extends AppCompatActivity {
    ...
    int count = 0, a, b, c, d;
    Button check_btn;
    Integer[] Images = {R.drawable.g1, R.drawable.g2, R.drawable.g3, R.drawable.g4};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g_h_6_2);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_h_6_2.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_h_6_2.this, Table_Easy.class));
            }
        });
    }
    ...
    public void checkIt(View view) {
        ...
        if ((int) btn1.getTag() == 0 && (int) btn2.getTag() == 1 && (int) btn3.getTag() == 2 && (int) btn4.getTag() == 3) {
            ...
            startActivity(new Intent(this, G_h_6_3.class));

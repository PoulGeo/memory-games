...
import com.example.memorygames.hard_level.Game1.G_h_1_2;
import com.example.memorygames.hard_level.Game1.G_h_1_3;

public class G_h_2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_h_2_1);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_h_2_1.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_h_2_1.this, Table_Easy.class));
            }
        });
    ...
    public void right_ans(View view) {
        img7.setBackgroundColor(this.getColor(R.color.colorPrimary));
        startActivity(new Intent(this, G_h_2_2.class));
        sound.playHitSound();
    }
    ...
    public void playNo_Cooking_Utensils(View view) {
        sound.playNo_Cooking_Utensils();
    }
}
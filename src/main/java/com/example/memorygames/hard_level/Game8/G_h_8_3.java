...
public class G_h_8_3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_h_8_3);
        ...
        iv_text.setText("13 - 7.75 = __ €");

        btn1.setImageResource(R.drawable.euro_5);
        btn2.setImageResource(R.drawable.cent_20);
        btn3.setImageResource(R.drawable.two_euro_coin);
        btn4.setImageResource(R.drawable.cent_5);

        user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_h_8_3.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_h_8_3.this, Table_Easy.class));
            }
        });

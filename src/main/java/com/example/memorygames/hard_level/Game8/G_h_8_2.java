...
public class G_h_8_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_g_h_8_2);
        ...
        iv_text.setText("25 - 12.5 = __ €");

        btn1.setImageResource(R.drawable.one_euro_coin);
        btn2.setImageResource(R.drawable.cent_50);
        btn3.setImageResource(R.drawable.cent_5);
        btn4.setImageResource(R.drawable.two_euro_coin);

        user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_h_8_2.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_h_8_2.this, Table_Easy.class));
            }
        });
    ...
    public void checkIt(View view) {
        if (!btn1.isSelected()&&btn2.isSelected()&&!btn3.isSelected()&&btn4.isSelected()){
            sound.playHitSound();
            startActivity(new Intent(this, G_h_8_3.class));
        }else {
            sound.playOverSound();
        }
    }

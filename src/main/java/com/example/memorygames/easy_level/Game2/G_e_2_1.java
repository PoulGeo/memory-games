...
public class G_e_2_1 extends AppCompatActivity {

    private static String key;
    private static DatabaseReference db, db1;
    public static long startTime;

    ImageButton img1, img2, img3, img4, user, help, close;
    public SoundPlayer sound;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g_e_2_1);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_e_2_1.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_e_2_1.this, Table_Easy.class));
            }
        });
    ...
    public void right_ans(View view) {
        img3.setBackgroundColor(this.getColor(R.color.colorPrimary));
        startActivity(new Intent(this, G_e_2_2.class));
        sound.playHitSound();
    }
    ...
    public void playNo_Animal(View view) {
        sound.playNo_Animal();
    }
}

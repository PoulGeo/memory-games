...
public class G_e_6_1 extends AppCompatActivity {
    ...
    int count = 0, a, b, c, d;
    Button check_btn;
    Integer[] Images = {R.drawable.three, R.drawable.six, R.drawable.eight, R.drawable.eighty};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_g_e_6_1);
        ...
        user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(G_e_6_1.this, SignUp.class));
            }
        });
        ...
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(G_e_6_1.this, Table_Easy.class));
            }
        });
    }
    ...
    public void checkIt(View view) {
        ...
        if ((int) btn1.getTag() == 0 && (int) btn2.getTag() == 1 && (int) btn3.getTag() == 2 && (int) btn4.getTag() == 3) {
            sound.playHitSound();
            startActivity(new Intent(this, G_e_6_2.class));
        }else{
            sound.playOverSound();
        }
    }
